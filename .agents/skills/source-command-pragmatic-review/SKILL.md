---
name: "source-command-pragmatic-review"
description: "Interactive pragmatic code review focusing on YAGNI and KISS principles"
---

# source-command-pragmatic-review

Use this skill when the user asks to run the migrated source command `pragmatic-review`.
